...
useful_features = feature_importance[-80:]
...
feature_importance = feature_importance[feature_importance['score'] > 90]
...
ml = mean_squared_error(target.values, oof_stack)
print(ml)
sub_df = pd.read_csv('../data/jinnan_round1_submit_20181227.csv', header=None)
sub_df[1] = predictions
sub_df[1] = sub_df[1].apply(lambda x: round(x, 3))
sub_df.to_csv("../data/20190114/" + str(ml) + ".csv", index=False, header=None)
